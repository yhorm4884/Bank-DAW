"""
Django settings for bank-odpcs project.
...
ROOT_URLCONF = 'bank-odpcs.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'bank-odpcs', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'bank-odpcs.wsgi.application'
