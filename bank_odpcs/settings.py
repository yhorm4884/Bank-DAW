"""
Django settings for bank_odpcs project.
...
ROOT_URLCONF = 'bank_odpcs.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'bank_odpcs', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'bank_odpcs.wsgi.application'
